        ...
        <div className="affiliate-create-product-panel affiliate-create-product-panel-main">
          ...
          <form className="affiliate-create-product-form" onSubmit={handleSubmit}>
            <div className="affiliate-create-product-form-grid">
              ...
              <div className="affiliate-create-product-field affiliate-create-product-field-full">
                <span className="affiliate-create-product-label">
                  <ImageIcon size={16} />
                  Product image
                </span>

                <label className="affiliate-create-product-upload-box">
                  <input
                    className="affiliate-create-product-file-input"
                    type="file"
                    accept="image/*"
                    onChange={handleImageFileChange}
                  />
                  <span className="affiliate-create-product-upload-inner">
                    <span className="affiliate-create-product-upload-icon">
                      <Upload size={18} />
                    </span>
                    <span className="affiliate-create-product-upload-text">
                      {uploadingImage ? 'Uploading image...' : 'Upload image from device'}
                    </span>
                    <span className="affiliate-create-product-upload-subtext">
                ...
                {selectedImageName ? (
                  <div className="affiliate-create-product-file-row">
                    <span className="affiliate-create-product-file-name">{selectedImageName}</span>
                    <button
                      type="button"
                      className="affiliate-create-product-file-remove"
                ...
                {form.product_image ? (
                  <div className="affiliate-create-product-image-preview-wrap">
                    <img
                      src={form.product_image}
                      alt="Product preview"
                      className="affiliate-create-product-image-preview"
                    />
                  </div>
                ) : null}
              </div>
