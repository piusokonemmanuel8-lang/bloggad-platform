...
export default function CustomerAdvertiserCampaignsPage() {
  ...
  useEffect(() => {
    ...
    async function loadCampaigns() {
      ...
      try {
        ...
        const [campaignsData, walletData] = await Promise.all([
          campaignsResponse.json(),
          walletResponse.json(),
        ]);

        if (!campaignsResponse.ok || !campaignsData?.ok) {
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          >
                            {campaign?.campaign_type || 'banner'} • {campaign?.buying_model || 'cpc'} • {campaign?.objective || 'traffic'}
                          </div>
                        </div>
